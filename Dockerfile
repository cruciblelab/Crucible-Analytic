...
COPY internal/backup/schema.sql     /opt/crucible-analytic/schema/11-backup.sql
COPY internal/schemaver/schema.sql  /opt/crucible-analytic/schema/12-schemaver.sql
